...
Rails.application.middleware.use OmniContacts::Builder do
  ...
  #Production
  importer :yahoo, "dj0yJmk9N1pzYUJ1bU9xNHVFJmQ9WVdrOWNFVkhSM1pTTkdjbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD1iYg--", "7d4e331067b6404d7b38e796078e13605a0df81f", {:callback_path => '/callback'}
end
